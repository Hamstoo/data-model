...
/**
  * User's recommendation based on recent autogenerated keywords(for now)
  *
  */
@Singleton
class RecommendationDao @Inject()(implicit db: () => Future[DefaultDB]) {
  ...
  /**
    ...
    * @param recommendations - a list of recommendations to be stored in mongodb
    * @return
    */
  ...
  /**
    * get recommendations assigned to a user, saved in the past days
  ...
  def retrieve(userId: UUID, nDaysBack: Int = RecommendationDao.DEFAULT_DAYS_BACK): Future[Seq[Recommendation]] = {
    ...
    // (Elias note) I think Fred decided to limit the keywords
