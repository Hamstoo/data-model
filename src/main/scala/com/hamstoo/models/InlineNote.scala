...
case class InlineNote(
                       ...
                       timeThru: Long = Long.MaxValue) extends Annotation with FrontendStub[InlineNote.Stub] {
  uPref = Some(url.binaryPrefix)

  override def stub: InlineNote.Stub = InlineNote.Stub(id, pos.text)
}
...
object InlineNote extends BSONHandlers {
  ...
  case class Stub(id: String, preview: String)
