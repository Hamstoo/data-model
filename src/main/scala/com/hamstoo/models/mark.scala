...
/**
  * This case class represent object that contain,
  *   as 1'st fields private representations id
  *   as 2'nd fields this representations expect rating
  * First field generated by repr-engine.RepresentationActor
  * And second one by repr-engine.ExpectedRatingActor
  * @param reprId - Representations ID
  * @param expRating - expected rating
  */
...
//                 privRepr: Option[String] = None,      // strings rather than objects so that they can be set to
                 ...
                 privReprExpRating: Seq[ReprRating] = Nil,
...
//  def expectedRating: Option[String] = reconcilePrivPub(privExpRating, pubExpRating)
  ...
  def eratablePrivate: Boolean = privReprExpRating.exists(_.eratable)
  ...
  def merge(oth: Mark): Mark = {
    ...
    copy(
      ...
      page = if ((privReprExpRating ++ oth.privReprExpRating).nonEmpty) Nil else if (oth.page.isEmpty) page else oth.page,
