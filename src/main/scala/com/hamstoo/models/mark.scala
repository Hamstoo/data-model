...
case class Page(mimeType: String, content: String)
...
object Mark extends BSONHandlers {
  ...
  val PAGE: String = nameOf[Mark](_.pages)
  ...
  val SCORE: String = nameOf[Mark](_.score) /* `text` index search score <projectedFieldName>, not a field name of the
  collection */
